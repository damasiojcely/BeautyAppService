...
public class BeautyDataStore {
    ...
    public BeautyDataStore(Connection connection){ this.setConnection(connection); }

    public BeautyDataStore(){
   ...
   public Stylist findStylistById(String id){
    ...
    public Reservation findReservationById(String id){
        if(getConnection() ==null)return  null;
        return  getReservationsEntity().findById(id,getClientsEntity(),getSchedulesEntity());
    }
    public Schedule findScheduleById(String id){
        if(getConnection() ==null)return  null;
        return  getSchedulesEntity().findById(id,getStylistsEntity(),getServicesEntity(),getSalonsEntity());
    }
   ...
   //Aqui falta como poner las dos  llaves primaria de  la tabla skill
    public Skill findSkillById(String id){
        if(getConnection() ==null)return  null;
        return  getSkillsEntity().findById(getStylistsEntity(),getServicesEntity());
    }
  ...
  public List<Reservation> findAllReservations(){
      return getConnection() ==null ? null:getReservationsEntity().findAll(getClientsEntity(),getSchedulesEntity());
  }
  public List<Schedule> findAllSchedules(){
      return getConnection() == null ? null:getSchedulesEntity().findAll(getStylistsEntity(),getServicesEntity(),getSalonsEntity());
  }
  public List<Service> findAllServices(){
      return getConnection() ==null  ?null:getServicesEntity().findAll();
  }
  public List<Location>findAllLocations(){return getConnection()==null ?null:getLocationsEntity().findAll();}
    //Aqui falta como poner las dos  llaves primaria de  la tabla skill
  public List<Skill> findAllSkills(){

      return getConnection() ==null ? null:getSkillsEntity().finAll(getStylistsEntity(),getServicesEntity());
  }
